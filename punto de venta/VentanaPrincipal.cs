...
namespace punto_de_venta
{
    public partial class VentanaPrincipal : Form
    {
        ...
        {
            FormularioCliente v1 = new FormularioCliente();
            this.Hide();
            v1.ShowDialog();
            this.Show();

        }
        private void B_Menu_Inventario_Click(object sender, EventArgs e)
        {
        ...
        private void B_Menu_Historial_Click(object sender, EventArgs e)
        {
        ...
        private void B_CodCliente_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (resultado2.Item1 == null || resultado2.Item2 == 101) 
                {
                    MessageBox.Show("El dato ingresado no es válido");
                }
                else
                {
                    ...
                    B_AgregarProducto.Enabled = true;
                }
